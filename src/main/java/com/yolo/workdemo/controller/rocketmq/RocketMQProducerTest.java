...
//        Message msg = new Message("PayOrderSuccessTopic", "TestTag", "TestKey", ("订单支付消息").getBytes(RemotingHelper.DEFAULT_CHARSET));
        Message msg = new Message("TopicOrderDbDate", "TableA", "TableA", ("binlog").getBytes(RemotingHelper.DEFAULT_CHARSET));
        msg.putUserProperty("a", "10");
        msg.putUserProperty("b", "abc");
//        Message message = new Message("CreateOrderInfomTopic", "orderInfoJson".getBytes());
